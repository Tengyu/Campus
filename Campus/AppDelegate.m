...
//    [Instabug startWithToken:@"87c1a7f6f4865c8b37af1794405355c5" captureSource:IBGCaptureSourceUIKit invocationEvent:IBGInvocationEventNone];
//    [Instabug setIsTrackingUserSteps:NO];
    ...
    eventVC = [EventViewController new];
    nv = [[UINavigationController alloc] initWithRootViewController:eventVC];
    [self.window.rootViewController addChildViewController:nv];
    [self.window.rootViewController.view addSubview:nv.view];
    [nv didMoveToParentViewController:self.window.rootViewController];
    nv.view.alpha = 0.0;
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Campus" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Campus.sqlite"];
