...
-(void)loadView{
    ...
    UINavigationBar *navBar = [[UINavigationBar alloc] initWithFrame:CGRectMake(0, 0, SVB.size.width, 40)];
    [self.view addSubview:navBar];
    self.navigationController.navigationBarHidden = NO;
    self.navigationController.navigationBar.barTintColor = TabBarBlue;
    self.navigationController.navigationBar.backgroundColor = TabBarBlue;
